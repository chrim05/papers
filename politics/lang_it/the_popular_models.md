...
* Comunismo (puro):
    ...
    * Selezione: Democrazia/Naturale

* Monarchia Assoluta:
    * Governance: Oligarchia
    * Mercato: Scarsa su entrambi i lati
    * Interazione: Cooperazione/Competizione
    * Selezione: Naturale
...
La **Scalabilità** dei modelli è un'altra importante caratteristica da considerare, caratteristica che viene introdotta proprio grazie all visione modulare.
Se infatti prima avremmo generalizzato dicendo, ad esempio, "Il comunismo (puro) non funziona, perchè non è possibile convincere tutti a cooperare senza imposizioni, e imponendolo non sarebbe più comunismo", ora possiamo affermare più correttamente che il comunismo è, invece, un modello a bassissima scalabilità e il sua applicabilità dipende strettamente dal contesto e dalla dimensione del gruppo, ad esempio: nelle famiglie non è raro affatto trovare un modello comunista e questo funziona senza alcun problema, grazie al bagaglio emotivo condiviso tra i membri del gruppo e la ristretta dimensione di quest'ultimo.

Altri modelli sono meno sensibili alla scalabilità, ma anche questi, a certi livelli, iniziano a soffrire di problemi altrettanto seri, tra cui alcuni esempi:
* Democrazia:
    * Voto divisivo: la società è divisa in 2 grandi fazioni, si tende a perdere di vista i veri obiettivi, a candidarsi solo per competere con partiti rivali, e a votare sulla base del comportamento dei personaggi e non delle loro idee
    * Voto manipolabile: fake news, propaganda illusoria, ..., Nonostante possano sembrare elementi secondari, costituiscono in realtà una vera piaga dei governi odierni
    * Voto ignorante: il voto è potenzialmente privo della dovuta ricerca e documentazione, spesso ci si può trovare a votare senza sapere precisamente il programma del candidato
    * A danno degli altri: la scelta del candidato è potenzialmente condizionata da interessi personali
    * Potenziale inversione di rotta ad ogni mandato, il paese potrebbe fare fatica a rimanere stabile su degli ideali, ribaltare rapporti internazionali importanti, ecc...
    * Indirezione: quella della democrazia moderna è principalmente una narrativa, mirata a convincere i cittadini di avere vero controllo sul futuro del paese e i Referendum sono insoliti
    * Rigidità Legislativa: la legislazione è in genere poco flessibile, rendendola poco disponibile a modifiche sostanziose, che è una utile protezione contro malintenzioni, ma molto limitante per le nuove idee, aggiungendo di fatto molta frizione nell'evoluzione della società, che dovrà affrontare problemi nuovi con strumenti vecchi
    * Opinione popolare meno di valore: spesso alcune dinamiche, soprattutto internazionali, necessitano un certo grado di riservatezza, rendendo di fatto l'opinione del popolo su certe tematiche, di minore importanza, siccome fondata su informazioni incomplete

* Socialismo:
    * Inefficienza organizzativa: i servizi pubblici tendono a perdere qualità e convenienza, optando per soluzioni private, come nel caso della sanità pubblica, che potrebbe richiedere per fino mesi per ottenere una visita importante, come una Tac o una Radiografia
    * Inefficienza della spesa pubblica: il personale incaricato di gestire la spesa pubblica potrebbe non badare a spese su alcuni fronti, come infatti spesso accade in Italia
    * Uguale ma non Equo: il walfare state ha bisogno di tassazioni elevate, che disincentivano i cittadini a fare impresa o a dichiarare redditi, al tempo stesso, perfino chi non lavora ha comunque diritto agli stessi servizi di chi ha messo a rischio i propri risparmi e i propri comfort

* Oligarchia:
    * Bassa trasparenza: alto rischio di corruzione
    * Tendenza oppressiva: poca libertà individuale, potresti trovarti costretto ad emigrare per sfuggire a regole che non condividi
...
La ricerca di un modello che risolva questi problemi non è affatto semplice, si consiglia la lettura del documento che tratta proprio questo argomento al percorso: `./my_own_model.md`